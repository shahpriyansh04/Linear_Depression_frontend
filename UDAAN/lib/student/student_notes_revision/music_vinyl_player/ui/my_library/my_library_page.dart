...
import 'package:udaan_app/student/student_notes_revision/music_vinyl_player/ui/my_library/widgets/my_library_widgets.dart';
...
class MyLibraryPageState extends State<MyLibraryPage> {
  ...
  late Album _selectedSong;
  late Album _currentPlaying;
  ...
  void initState() {
    ...
    _selectedSong = Album.listAlbum[1];
    _currentPlaying = Album.listAlbum[1];
    super.initState();
  }
  ...
  void _pageDescriptionListener() {
    ...
    // Update song selection when album changes
  void _updateSelectedSong(int albumIndex) {
    setState(() {
      _selectedSong = Album.listAlbum[albumIndex];
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        _updateSelectedSong(value); // Update selected song when album changes
      });
                      },
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      child: SongPlayFooter(
                          song: Song(
                        title: _currentPlaying.subject!,
                        duration: const Duration(seconds: 220),
                        album: _currentPlaying,
                      ),
