...
const atRiskStudents = [
  ...
  },
  {
    ...
    grade: 68,
    attendance: 75,
    reason: "Struggling with recent topics",
    parentId: "9",
  },
  {
    id: "3",
...
const recentChats = [
  {
    id: 1,
    parent: "Mr. Mrudul",
    student: "Vedica Mrudul",
    lastMessage: "Thank you for the update on Vedica's progress.",
  },
  {
    id: 2,
    parent: "Mrs. Patel",
    student: "Sarth patel",
    lastMessage:
      "I'd like to schedule a meeting to discuss sarth's performance.",
  },
  {
    id: 3,
    parent: "Mr. Shah",
    student: "Priyansh Shah",
    lastMessage: "Priyansh has been working hard on his math assignments.",
  },
];
                  ...
                  <TableRow key={student.id} className="hover:bg-red-50">
                    ...
                    <TableCell>
                      <Button
                        ...
                        onClick={() => handleContactParents(student.parentId)}
                      >
                        Contact Parents
                      </Button>
                    </TableCell>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {classesData.map((classItem, index) => (
              ...
              <Card
                key={index}
                className={`bg-${["blue", "green", "pink"][index]}-100`}
              >
                <CardHeader>
                ...
                <TableHeader>
                  <TableRow>
                    {Object.keys(csvData[0]).map((key, index) => (
                      <TableHead key={index} className="p-4">
                        {key}
                      </TableHead>
                    ))}
                  </TableRow>
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Advanced Algebra">
                          Advanced Algebra
                        </SelectItem>
                        <SelectItem value="Geometry Basics">
                          Geometry Basics
                        </SelectItem>
                      </SelectContent>
                    </Select>
            ...
            <ul className="space-y-2">
              {recentChats.map((chat) => (
                <li key={chat.id} className="border-b pb-2">
                  <span className="font-semibold">{chat.parent}</span> -{" "}
                  {chat.student}
